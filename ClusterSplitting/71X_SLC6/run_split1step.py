...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ZpTauTau8TeV_split_1step.root'),
...
#process.schedule = cms.Schedule(process.init_step,process.splitClusters_step,process.RECOoutput_step)
