...
#    MeasurementTracker.pixelClusterProducer = newpixclusters
#    MeasurementTracker.stripClusterProducer = newstripclusters
    ...
    photonConvTrajSeedFromQuadruplets.ClusterCheckPSet.PixelClusterCollectionLabel = newpixclusters
    photonConvTrajSeedFromQuadruplets.ClusterCheckPSet.ClusterCollectionLabel      = newstripclusters
    convClusters.pixelClusters = newpixclusters
    convClusters.stripClusters = newstripclusters
    conv2Clusters.pixelClusters = newpixclusters
    conv2Clusters.stripClusters = newstripclusters
