...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string(' TTbar536_nosplit_RECO.root'),
...
process.schedule = cms.Schedule(process.init_step,process.fullreco_step,process.RECOoutput_step,process.pixeltree_nosplit,process.p)
