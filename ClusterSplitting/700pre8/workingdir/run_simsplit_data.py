...
process.PixelTreeSplit = cms.EDAnalyzer(
    ...
    globalTag              = cms.string("START70_V1::All"),
...
process.pre_init  = cms.Path(cms.Sequence(process.mix*process.pdigi*process.SimL1Emulator*process.DigiToRaw))
...
#process.schedule = cms.Schedule(process.pre_init,process.init_step,process.rechits_step, process.splitClusters_step,process.newrechits_step,process.fullreco_step,process.RECOoutput_step, process.p)
