...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        'root://eoscms///eos/cms/store/relval/CMSSW_7_0_0_pre8/RelValTTbar/GEN-SIM-DIGI-RAW-HLTDEBUG/START70_V1-v1/00000/262AA156-744A-E311-9829-002618943945.root'
),
...
######## track to vertex assoc ##################
process.load('CommonTools.RecoUtils.pf_pu_assomap_cfi')
...
#process.load('splitter_tracking_setup_cff') # not used, no splitting
...
# Output definition
process.PixelTreeNoSplit = cms.EDAnalyzer(
    "PixelAnalysisTree",
    verbose                = cms.untracked.int32(0),
    rootFileName           = cms.untracked.string('pixelTrees_NS_DATA.root'),
    treeName               = cms.untracked.string('treeNoSplit'),
...
process.RECOoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string(' TTbar700_nosplit_RECO.root'),
...
process.pixeltree_nosplit =cms.Path(process.PixelTreeNoSplit)
...
process.multiTrackValidator.outputFile = 'valid_NS_MC_chi2.root'
...
#process.schedule = cms.Schedule(process.init_step,process.fullreco_step,process.vertex_assoc,process.pixeltree_nosplit)
process.schedule = cms.Schedule(process.init_step,process.fullreco_step,process.RECOoutput_step,process.p, process.pixeltree_nosplit)
