...
process.multiTrackValidator.outputFile = 'valid_TS_MC_chi2.root'
...
process.schedule = cms.Schedule(process.init_step,process.splitClusters_step,process.newrechits_step,process.fullreco_step,process.RECOoutput_step, process.p)
