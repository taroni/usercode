...
class RecHitSimpleAnalyser : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit RecHitSimpleAnalyser(const edm::ParameterSet&);
...
//
RecHitSimpleAnalyser::RecHitSimpleAnalyser(const edm::ParameterSet& iConfig)
{
  ebRecHitToken_ = consumes<EBRecHitCollection>(iConfig.getParameter<edm::InputTag>("EBrechitCollection"));
  
  //  ebUncalibRecHitToken_ = consumes<EBRecHitCollection>(iConfig.getParameter<edm::InputTag>("EBuncalibRecHitCollection"));
   //now do what ever initialization is needed

}


RecHitSimpleAnalyser::~RecHitSimpleAnalyser()
{
...
void
RecHitSimpleAnalyser::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   ...
   iEvent.getByToken(ebRecHitToken_, pEBRecHits);
   ...
   for (EBRecHitCollection::const_iterator it = ebRecHits->begin(); it != ebRecHits->end();
     ++it) {
...
void
RecHitSimpleAnalyser::endJob()
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
RecHitSimpleAnalyser::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(RecHitSimpleAnalyser);
