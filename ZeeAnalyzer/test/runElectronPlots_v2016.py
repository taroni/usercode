...
process.source = cms.Source ("PoolSource", fileNames =inputFilesMC) #fileNames = cms.untracked.vstring('file:/tmp/taroni/00F9D855-E293-E711-B625-02163E014200.root') )                             
...
process.load("SimpleAnalyzer/ZeeAnalyzer/zeeSkimVetoId2016") 
