...
#process.load("SimpleAnalyzer/ZeeSkim/ZeeSkim_cfi") 
#process.load("DPGAnalysis/Skims/ZeeSkim_cfi")
#process.load("DPGAnalysis/Skims/ZElectronsSkim_cfi")
process.load("DPGAnalysis/Skims/ZElectronsSelector_cfi")
...
process.pout = cms.OutputModule("PoolOutputModule",
...
#process.p = cms.Path(process.zdiElectronSequence*process.ntupler)
#process.outpath = cms.EndPath(process.pout)
