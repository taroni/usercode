...
{  
   ...
   TH3I * TPMatchEmul3D_sevlv1 = new TH3I("TPMatchEmul3D_sevlv1", "TP data matching Emulator, severity level 1", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPMatchEmul3D_sevlv1->GetYaxis()->SetTitle("eta index") ;
   TPMatchEmul3D_sevlv1->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPMatchEmul3D_sevlv2 = new TH3I("TPMatchEmul3D_sevlv2", "TP data matching Emulator, severity level 2", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPMatchEmul3D_sevlv2->GetYaxis()->SetTitle("eta index") ;
   TPMatchEmul3D_sevlv2->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPMatchEmul3D_sevlv3 = new TH3I("TPMatchEmul3D_sevlv3", "TP data matching Emulator, severity level 3", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPMatchEmul3D_sevlv3->GetYaxis()->SetTitle("eta index") ;
   TPMatchEmul3D_sevlv3->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPMatchEmul3D_sevlv4 = new TH3I("TPMatchEmul3D_sevlv4", "TP data matching Emulator, severity level 4", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPMatchEmul3D_sevlv4->GetYaxis()->SetTitle("eta index") ;
   TPMatchEmul3D_sevlv4->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPMatchEmul3D_sevlv5 = new TH3I("TPMatchEmul3D_sevlv5", "TP data matching Emulator, severity level 5", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPMatchEmul3D_sevlv5->GetYaxis()->SetTitle("eta index") ;
   TPMatchEmul3D_sevlv5->GetXaxis()->SetTitle("phi index") ;
   ...
   TH3I * TPEmulMax3D_sevlv1 = new TH3I("TPEmulMax3D_sevlv1", "Index of max TP Emulator 3D, severity level 1 ", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPEmulMax3D_sevlv1->GetYaxis()->SetTitle("eta index") ;
   TPEmulMax3D_sevlv1->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPEmulMax3D_sevlv2 = new TH3I("TPEmulMax3D_sevlv2", "Index of max TP Emulator 3D, severity level 2 ", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPEmulMax3D_sevlv2->GetYaxis()->SetTitle("eta index") ;
   TPEmulMax3D_sevlv2->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPEmulMax3D_sevlv3 = new TH3I("TPEmulMax3D_sevlv3", "Index of max TP Emulator 3D, severity level 3 ", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPEmulMax3D_sevlv3->GetYaxis()->SetTitle("eta index") ;
   TPEmulMax3D_sevlv3->GetXaxis()->SetTitle("phi index") ;
   TH3I * TPEmulMax3D_sevlv4 = new TH3I("TPEmulMax3D_sevlv4", "Index of max TP Emulator 3D, severity level 4 ", 72, 1, 73, 57, -28, 29, 7, -1, 6) ;
   TPEmulMax3D_sevlv4->GetYaxis()->SetTitle("eta index") ;
   TPEmulMax3D_sevlv4->GetXaxis()->SetTitle("phi index") ;
   ...
   TH2F * etaphi_EB_sevlv1 = new TH2F("etaphi_EB_sevlv1", "Tower severity level 1: Barrel", 72, 1, 73, 38, -19, 19) ;
   TH2F * etaphi_EB_sevlv2 = new TH2F("etaphi_EB_sevlv2", "Tower severity level 2: Barrel", 72, 1, 73, 38, -19, 19) ;
   TH2F * etaphi_EB_sevlv3 = new TH2F("etaphi_EB_sevlv3", "Tower severity level 3: Barrel", 72, 1, 73, 38, -19, 19) ;
   TH2F * etaphi_EB_sevlv4 = new TH2F("etaphi_EB_sevlv4", "Tower severity level 4: Barrel", 72, 1, 73, 38, -19, 19) ;
   TH2F * etaphi_EB_sevlv5 = new TH2F("etaphi_EB_sevlv5", "Tower severity level 5: Barrel", 72, 1, 73, 38, -19, 19) ;
 
   TH2F * etaphi_EEPlus_sevlv1 = new TH2F("etaphi_EEPlus_sevlv1", "Tower severity level 1: EE+", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEPlus_sevlv2 = new TH2F("etaphi_EEPlus_sevlv2", "Tower severity level 2: EE+", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEPlus_sevlv3 = new TH2F("etaphi_EEPlus_sevlv3", "Tower severity level 3: EE+", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEPlus_sevlv4 = new TH2F("etaphi_EEPlus_sevlv4", "Tower severity level 4: EE+", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEPlus_sevlv5 = new TH2F("etaphi_EEPlus_sevlv5", "Tower severity level 5: EE+", 121, -10, 111, 121, -10, 111) ;

   TH2F * etaphi_EEMinus_sevlv1 = new TH2F("etaphi_EEMinus_sevlv1", "Tower severity level 1: EE-", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEMinus_sevlv2 = new TH2F("etaphi_EEMinus_sevlv2", "Tower severity level 2: EE-", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEMinus_sevlv3 = new TH2F("etaphi_EEMinus_sevlv3", "Tower severity level 3: EE-", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEMinus_sevlv4 = new TH2F("etaphi_EEMinus_sevlv4", "Tower severity level 4: EE-", 121, -10, 111, 121, -10, 111) ;
   TH2F * etaphi_EEMinus_sevlv5 = new TH2F("etaphi_EEMinus_sevlv5", "Tower severity level 5: EE-", 121, -10, 111, 121, -10, 111) ;
   ...
   for (int entry = firstEntry ; entry < lastEntry ; ++entry)
   {
	 ...
	 //if(raw_spike ==0 )  std::cout <<__LINE__ << " event: " << evNb  << ", spike? " << raw_spike << " adc: " << tp << " sFGVB:" << treeVars.trig_tower_sFGVB[tower] << " tower: " <<tower << " eta: " << ieta <<  endl; 
	 if (ieta >0)
	   hashedIndex = ieta * 100 + iphi ;
	 else 
	   hashedIndex = ieta * 100 - iphi ; 
	 ...
	 if (abs(ieta) < 18 ) {
	   if ( raw_spike==0 &&  tp > occupancyCut)  {
	     //std::cout <<__LINE__ << " " << raw_spike << " " << treeVars.trig_tower_adc[tower] << " " << treeVars.trig_tower_sFGVB[tower] << " " <<tower << " " << ieta << " " << iphi<<  endl; 
	     spikesEB2D ->Fill (iphi, ieta); 
	     spikesEB2DADC->Fill (iphi, ieta, tp ) ; 
	   }
	   if (tp > occupancyCut){
	     if (treeVars.sevlv[tower] == 1) {
	       etaphi_EB_sevlv1 -> Fill(iphi, ieta); 
	     } else if (treeVars.sevlv[tower] == 2){
	       etaphi_EB_sevlv2 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 3){
	   ...
	   if (tp > occupancyCut) {
	     ...
	     if (treeVars.sevlv[tower] == 1) {
	       etaphi_EEPlus_sevlv1 -> Fill(iphi, ieta); 
	     } else if (treeVars.sevlv[tower] == 2){
	       etaphi_EEPlus_sevlv2 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 3){
	       etaphi_EEPlus_sevlv3 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 4){
	       etaphi_EEPlus_sevlv4 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 5){
	       etaphi_EEPlus_sevlv5 -> Fill(iphi, ieta); 
	     }
	   }
	 }else if (ieta <= -18) {
	   if (tp > occupancyCut) {
	     ...
	     if (treeVars.sevlv[tower] == 1) {
	       etaphi_EEMinus_sevlv1 -> Fill(iphi, ieta); 
	     } else if (treeVars.sevlv[tower] == 2){
	       etaphi_EEMinus_sevlv2 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 3){
	       etaphi_EEMinus_sevlv3 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 4){
	       etaphi_EEMinus_sevlv4 -> Fill(iphi, ieta); 
	     }else if (treeVars.sevlv[tower] == 5){
	       etaphi_EEMinus_sevlv5 -> Fill(iphi, ieta); 
	     }
	   }
	 }
	...
	TPEmulMax3D->Fill(iphi, ieta, indexOfTPEmulMax+1 );
	if (treeVars.sevlv[tower] == 1 ) TPEmulMax3D_sevlv1->Fill(iphi, ieta, indexOfTPEmulMax+1 );
	if (treeVars.sevlv[tower] == 2 ) TPEmulMax3D_sevlv2->Fill(iphi, ieta, indexOfTPEmulMax+1 );
	if (treeVars.sevlv[tower] == 3 ) TPEmulMax3D_sevlv3->Fill(iphi, ieta, indexOfTPEmulMax+1 );
	if (treeVars.sevlv[tower] == 4 ) TPEmulMax3D_sevlv4->Fill(iphi, ieta, indexOfTPEmulMax+1 );
	if (treeVars.sevlv[tower] == 5 ) TPEmulMax3D_sevlv5->Fill(iphi, ieta, indexOfTPEmulMax+1 );
      ...
      if (tp>occupancyCut && abs(ieta)<18)
      {
         //barrel
      ...
      if (emul[ref]>occupancyCut && abs(ieta)<18) {
	
	occupancyTPEmulEB->Fill(iphi, ieta) ;  //barrel
      }
      if (debug){
	
	//if((emul[ref]>occupancyCut && abs(ieta)<18) && !(tp>occupancyCut && abs(ieta)<18))  std::cout << __PRETTY_FUNCTION__ << " " << __LINE__ << " event " << evNb  << " " <<treeVars.lumiBlock <<  " entry: " << entry <<  ", emul: "  << emul[ref] <<  ", ref: " << ref << ", occupancyCut:  " << occupancyCut << ", , tp:  " << tp << ", ieta:  " << ieta << ", iphi; " << iphi<< ", tower: " << tower<<  ", nbofXtals: " << treeVars.nbOfXtals[tower] << ", eRec: " <<  treeVars.eRec[tower] << ", spike: " << treeVars.spike[tower]<< std::endl;  
      }
   ...
   TH2F * TPMatchFractionEB2D_sevlv1 = new TH2F("TPMatchFractionEB2D_sevlv1", "TP data: fraction of non-single timing, severity level 1: Barrel", 72, 1, 73, 38, -19, 19) ;
   TPMatchFractionEB2D->GetYaxis()->SetTitle("eta index") ; 
   TPMatchFractionEB2D->GetXaxis()->SetTitle("phi index") ;
   TH2F * TPMatchFractionEEPlus2D_sevlv1 = new TH2F("TPMatchFractionEEPlus2D_sevlv1", "TP data: fraction of non-single timing, severity level 1: Plus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEPlus2D_sevlv1->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEPlus2D_sevlv1->GetXaxis()->SetTitle("x index") ;
   TH2F * TPMatchFractionEEMinus2D_sevlv1 = new TH2F("TPMatchFractionEEMinus2D_sevlv1", "TP data: fraction of non-single timing, severity level 1: Minus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEMinus2D->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEMinus2D->GetXaxis()->SetTitle("x index") ;

   TH2F * TPMatchFractionEB2D_sevlv2 = new TH2F("TPMatchFractionEB2D_sevlv2", "TP data: fraction of non-single timing, severity level 2: Barrel", 72, 1, 73, 38, -19, 19) ;
   TPMatchFractionEB2D_sevlv2->GetYaxis()->SetTitle("eta index") ; 
   TPMatchFractionEB2D_sevlv2->GetXaxis()->SetTitle("phi index") ;
   TH2F * TPMatchFractionEEPlus2D_sevlv2 = new TH2F("TPMatchFractionEEPlus2D_sevlv2", "TP data: fraction of non-single timing, severity level 2: Plus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEPlus2D_sevlv2->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEPlus2D_sevlv2->GetXaxis()->SetTitle("x index") ;
   TH2F * TPMatchFractionEEMinus2D_sevlv2 = new TH2F("TPMatchFractionEEMinus2D_sevlv2", "TP data: fraction of non-single timing, severity level 2: Minus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEMinus2D_sevlv2->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEMinus2D_sevlv2->GetXaxis()->SetTitle("x index") ;

   TH2F * TPMatchFractionEB2D_sevlv3 = new TH2F("TPMatchFractionEB2D_sevlv3", "TP data: fraction of non-single timing, severity level 3: Barrel", 72, 1, 73, 38, -19, 19) ;
   TPMatchFractionEB2D_sevlv3->GetYaxis()->SetTitle("eta index") ; 
   TPMatchFractionEB2D_sevlv3->GetXaxis()->SetTitle("phi index") ;
   TH2F * TPMatchFractionEEPlus2D_sevlv3 = new TH2F("TPMatchFractionEEPlus2D_sevlv3", "TP data: fraction of non-single timing, severity level 3: Plus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEPlus2D_sevlv3->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEPlus2D_sevlv3->GetXaxis()->SetTitle("x index") ;
   TH2F * TPMatchFractionEEMinus2D_sevlv3 = new TH2F("TPMatchFractionEEMinus2D_sevlv3", "TP data: fraction of non-single timing, severity level 3: Minus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEMinus2D_sevlv3->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEMinus2D_sevlv3->GetXaxis()->SetTitle("x index") ;

   TH2F * TPMatchFractionEB2D_sevlv4 = new TH2F("TPMatchFractionEB2D_sevlv4", "TP data: fraction of non-single timing, severity level 4: Barrel", 72, 1, 73, 38, -19, 19) ;
   TPMatchFractionEB2D_sevlv4->GetYaxis()->SetTitle("eta index") ; 
   TPMatchFractionEB2D_sevlv4->GetXaxis()->SetTitle("phi index") ;
   TH2F * TPMatchFractionEEPlus2D_sevlv4 = new TH2F("TPMatchFractionEEPlus2D_sevlv4", "TP data: fraction of non-single timing, severity level 4: Plus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEPlus2D_sevlv4->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEPlus2D_sevlv4->GetXaxis()->SetTitle("x index") ;
   TH2F * TPMatchFractionEEMinus2D_sevlv4 = new TH2F("TPMatchFractionEEMinus2D_sevlv4", "TP data: fraction of non-single timing, severity level 4: Minus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEMinus2D_sevlv4->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEMinus2D_sevlv4->GetXaxis()->SetTitle("x index") ;

   TH2F * TPMatchFractionEB2D_sevlv5 = new TH2F("TPMatchFractionEB2D_sevlv5", "TP data: fraction of non-single timing, severity level 5: Barrel", 72, 1, 73, 38, -19, 19) ;
   TPMatchFractionEB2D_sevlv5->GetYaxis()->SetTitle("eta index") ; 
   TPMatchFractionEB2D_sevlv5->GetXaxis()->SetTitle("phi index") ;
   TH2F * TPMatchFractionEEPlus2D_sevlv5 = new TH2F("TPMatchFractionEEPlus2D_sevlv5", "TP data: fraction of non-single timing, severity level 5: Plus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEPlus2D_sevlv5->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEPlus2D_sevlv5->GetXaxis()->SetTitle("x index") ;
   TH2F * TPMatchFractionEEMinus2D_sevlv5 = new TH2F("TPMatchFractionEEMinus2D_sevlv5", "TP data: fraction of non-single timing, severity level 5: Minus Endcap", 121, -10, 111, 121, -10, 111) ;
   TPMatchFractionEEMinus2D_sevlv5->GetYaxis()->SetTitle("y index") ; 
   TPMatchFractionEEMinus2D_sevlv5->GetXaxis()->SetTitle("x index") ;

   vector < TH3I* >  EmulMax;
   vector < TH3I* >  MatchEmul;
   vector < TH2F* >  fractionBarrel; 
   vector < TH2F* >  fractionEndcapPlus; 
   vector < TH2F* >  fractionEndcapMinus; 
   EmulMax.push_back(TPEmulMax3D_sevlv1);
   EmulMax.push_back(TPEmulMax3D_sevlv2);
   EmulMax.push_back(TPEmulMax3D_sevlv3);
   EmulMax.push_back(TPEmulMax3D_sevlv4);
   EmulMax.push_back(TPEmulMax3D_sevlv5);
   MatchEmul.push_back(TPMatchEmul3D_sevlv1);
   MatchEmul.push_back(TPMatchEmul3D_sevlv2);
   MatchEmul.push_back(TPMatchEmul3D_sevlv3);
   MatchEmul.push_back(TPMatchEmul3D_sevlv4);
   MatchEmul.push_back(TPMatchEmul3D_sevlv5);
   fractionBarrel.push_back(TPMatchFractionEB2D_sevlv1);
   fractionBarrel.push_back(TPMatchFractionEB2D_sevlv2);
   fractionBarrel.push_back(TPMatchFractionEB2D_sevlv3);
   fractionBarrel.push_back(TPMatchFractionEB2D_sevlv4);
   fractionBarrel.push_back(TPMatchFractionEB2D_sevlv5);
   fractionEndcapPlus.push_back(TPMatchFractionEEPlus2D_sevlv1);
   fractionEndcapPlus.push_back(TPMatchFractionEEPlus2D_sevlv2);
   fractionEndcapPlus.push_back(TPMatchFractionEEPlus2D_sevlv3);
   fractionEndcapPlus.push_back(TPMatchFractionEEPlus2D_sevlv4);
   fractionEndcapPlus.push_back(TPMatchFractionEEPlus2D_sevlv5);
   fractionEndcapMinus.push_back(TPMatchFractionEEMinus2D_sevlv1);
   fractionEndcapMinus.push_back(TPMatchFractionEEMinus2D_sevlv2);
   fractionEndcapMinus.push_back(TPMatchFractionEEMinus2D_sevlv3);
   fractionEndcapMinus.push_back(TPMatchFractionEEMinus2D_sevlv4);
   fractionEndcapMinus.push_back(TPMatchFractionEEMinus2D_sevlv5);
   ...
   for (uint isev =0; isev<fractionBarrel.size(); isev++){
     for (int binx=1 ; binx<=72 ; binx++) {  //looping over iphi
       for (int biny=1 ; biny<=57 ; biny++) { //looping over ieta
         int maxBinEmulz = -1 ;
         double maxEmulCell = EmulMax[isev]->GetBinContent(binx, biny, maxBinEmulz) ;
         double totalEmulCell(0) ;
         for (int binz=1; binz<=7 ; binz++) {
            double content = EmulMax[isev]->GetBinContent(binx, biny, binz) ;
            if (content>maxEmulCell) {
               maxEmulCell = content ;
               maxBinEmulz = binz ;
            }
         ...
         int maxBinz = 5 ;
         double maxCell = MatchEmul[isev]->GetBinContent(binx, biny, maxBinz) ;
         double totalCell(0) ;
         double totalCell2(0) ;
         
         for (int binz=1; binz<=7 ; binz++) {
            double content = MatchEmul[isev]->GetBinContent(binx, biny, binz) ;
	   ...
	   int hashedIndex = (biny-29) * 100 - binx ;     
            ...
            if (totalCell>0) fraction = 1.- maxCell/totalCell ;
            for (uint i=0; i !=geometry[hashedIndex].size();++i) {
               fractionEndcapMinus[isev]->Fill(geometry[hashedIndex][i].first,geometry[hashedIndex][i].second,fraction ) ;         
            }
	 }  else if(biny<=46 && biny!=29) { 
	   //barrel (excluding ieta=0)
	   double fraction = 0 ;
	   if (totalCell>0) fraction = 1.- maxCell/totalCell ;
	   fractionBarrel[isev]->SetBinContent(binx, biny-9, fraction) ;
	 }  else if(biny>=47)  { 
            //plus endcap (ieta >=18)
            int hashedIndex = (biny-29) * 100 + binx ;
            ...
            if (totalCell>0) fraction = 1.- maxCell/totalCell ;
            for (uint i=0; i !=geometry[hashedIndex].size();++i) {
               fractionEndcapPlus[isev]->Fill(geometry[hashedIndex][i].first,geometry[hashedIndex][i].second,fraction ) ;       
	    }
         }
       }//end loop over ieta
   ...
   etaphi_EB_sevlv1 ->Write();
   etaphi_EB_sevlv2 ->Write();
   etaphi_EB_sevlv3 ->Write();
   etaphi_EB_sevlv4 ->Write();
   etaphi_EB_sevlv5 ->Write();

   etaphi_EEPlus_sevlv1 ->Write();
   etaphi_EEPlus_sevlv2 ->Write();
   etaphi_EEPlus_sevlv3 ->Write();
   etaphi_EEPlus_sevlv4 ->Write();
   etaphi_EEPlus_sevlv5 ->Write();
 
   etaphi_EEMinus_sevlv1  ->Write();
   etaphi_EEMinus_sevlv2  ->Write();
   etaphi_EEMinus_sevlv3  ->Write();
   etaphi_EEMinus_sevlv4  ->Write();
   etaphi_EEMinus_sevlv5  ->Write();
   ...
   TPMatchFractionEEMinus2D_sevlv1->Write() ; 
   TPMatchFractionEB2D_sevlv2->Write() ;
   TPMatchFractionEEPlus2D_sevlv2->Write() ; 
   TPMatchFractionEEMinus2D_sevlv2->Write() ; 
   TPMatchFractionEB2D_sevlv3->Write() ;
   TPMatchFractionEEPlus2D_sevlv3->Write() ; 
   TPMatchFractionEEMinus2D_sevlv3->Write() ; 
   TPMatchFractionEB2D_sevlv4->Write() ;
   TPMatchFractionEEPlus2D_sevlv4->Write() ; 
   TPMatchFractionEEMinus2D_sevlv4->Write() ; 
   TPMatchFractionEB2D_sevlv5->Write() ;
   ...
   spikesEB2D->Write(); 
   spikesEB2DADC->Write(); 
   spikesEEPlus2D->Write(); 
   spikesEEPlus2DADC->Write(); 
   spikesEEMinus2D->Write(); 
   spikesEEMinus2DADC->Write(); 
