...
#ifdef dimensions_cxx
dimensions::dimensions(TTree *tree) : fChain(0) 
{
...
Int_t dimensions::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dimensions::LoadTree(Long64_t entry)
{
...
void dimensions::Init(TTree *tree)
{
...
void dimensions::Show(Long64_t entry)
{
...
Int_t dimensions::Cut(Long64_t entry)
{
