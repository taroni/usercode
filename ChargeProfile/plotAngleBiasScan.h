...
#ifndef plotAngleBiasScan_h
#define plotAngleBiasScan_h
#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
#include "Riostream.h" 
...
public :
  //   TFile          *f; 
   ...
   plotAngleBiasScan(TTree *tree=0);
   virtual ~plotAngleBiasScan();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(int ievent =-1);
...
#ifdef plotAngleBiasScan_cxx
plotAngleBiasScan::plotAngleBiasScan(TTree *tree) : fChain(0) 
{
...
plotAngleBiasScan::~plotAngleBiasScan()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t plotAngleBiasScan::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plotAngleBiasScan::LoadTree(Long64_t entry)
{
...
void plotAngleBiasScan::Init(TTree *tree)
{
...
Bool_t plotAngleBiasScan::Notify()
{
...
void plotAngleBiasScan::Show(Long64_t entry)
{
...
Int_t plotAngleBiasScan::Cut(Long64_t entry)
{
