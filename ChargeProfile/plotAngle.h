...
Int_t plotAngle::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plotAngle::LoadTree(Long64_t entry)
{
...
void plotAngle::Init(TTree *tree)
{
...
void plotAngle::Show(Long64_t entry)
{
...
Int_t plotAngle::Cut(Long64_t entry)
{
