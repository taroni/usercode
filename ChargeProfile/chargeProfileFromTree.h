...
#ifndef chargeProfileFromTree_h
#define chargeProfileFromTree_h
#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
#include "Riostream.h" 
...
chargeProfileFromTree::~chargeProfileFromTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t chargeProfileFromTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t chargeProfileFromTree::LoadTree(Long64_t entry)
{
...
void chargeProfileFromTree::Init(TTree *tree)
{
...
Bool_t chargeProfileFromTree::Notify()
{
...
void chargeProfileFromTree::Show(Long64_t entry)
{
...
Int_t chargeProfileFromTree::Cut(Long64_t entry)
{
